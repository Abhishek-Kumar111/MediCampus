...
const AboutUs = () => {
  return (
    <div className='about-us'>
        ...
        <a className='about-link' href='https://nitm.ac.in/nitmeghalaya/ckfinder/userfiles/files/SOP%20for%20Institute%20Ambulance(1).pdf' target='_blank'>SoPs for NIT Meghalaya health center services</a>
